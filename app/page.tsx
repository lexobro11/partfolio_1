...
export default function Portfolio() {
  ...
  const skills = [
    { name: "HTML", level: "Mutaxassis", color: "bg-orange-500", percentage: 90},
            ...
            <nav className="flex justify-between items-center">
              <div className="flex items-center space-x-3">
                <Image
                  ...
                  width={40}
                  height={40}
                  className="rounded-lg, ounded-full"
                />
        ...
        <section className="py-16 md:py-24 px-4 bg-gradient-to-br from-slate-50 to-white dark:from-slate-900 dark:to-slate-800">
          <div className="container mx-auto text-center">
            ...
            <p className="text-base md:text-lg text-slate-600 dark:text-slate-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              HTML, CSS, JavaScript, TypeScript va UI/UX design texnologiyalarida tajribali veb dasturchi. Zamonaviy va
